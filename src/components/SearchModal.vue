      ...
      <div ref="modalContent" class="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg dark:bg-slate-800">
        ...
        <div class="py-4 px-2 space-y-4">
          ...
          <!-- <div>
            ...
            <ul>
              <li>
                <router-link class="flex items-center px-2 py-1 leading-6 text-sm text-slate-800 hover:bg-slate-100 rounded dark:text-slate-200 dark:hover:bg-slate-700" to="#0" @click="$emit('close-modal')">
